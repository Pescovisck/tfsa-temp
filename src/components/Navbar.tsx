...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="border-b border-slate-200/90 dark:border-slate-800/90 bg-white/95 dark:bg-[#0c0d12]/95 backdrop-blur-md sticky top-0 z-40 shadow-[0_2px_12px_rgba(15,23,42,0.04)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.5)]">
        ...
        <div className="flex items-center justify-between h-16 sm:h-20 gap-2">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3.5 min-w-0 flex-shrink">
            <div className="relative flex-shrink-0">
              <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-xl bg-white dark:bg-[#141722] border-2 border-[#c5a059] flex items-center justify-center p-1 sm:p-1.5 shadow-[0_2px_12px_rgba(197,160,89,0.25)] hover:scale-105 transition-transform">
                <img src="/logo.svg" alt="THE FINALS SA Logo" className="w-full h-full object-contain" />
              </div>
              <div className="absolute -top-1 -right-1 w-2.5 h-2.5 sm:w-3 sm:h-3 bg-[#c5a059] rounded-full border-2 border-white dark:border-[#0c0d12]"></div>
            </div>
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] sm:text-[11px] text-slate-500 dark:text-slate-400 font-mono tracking-wide hidden sm:block truncate">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 flex-shrink-0">
            ...
            {/* Live Indicator */}
            <div className="flex items-center space-x-1.5 sm:space-x-2 px-2.5 sm:px-3.5 py-1 sm:py-1.5 rounded-full bg-slate-50 dark:bg-[#141722] border border-slate-200/90 dark:border-slate-800 shadow-sm text-xs">
              <span className="relative flex h-2 w-2 flex-shrink-0">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-500 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
              </span>
              <span className="text-[11px] sm:text-xs font-semibold text-slate-700 dark:text-slate-300 font-['Chakra_Petch',sans-serif]">
